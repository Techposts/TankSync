...
/**
 * Draw a vertical capsule (pill) — no lid, stays inside the [x..x+w-1, y..y+h-1]
 * box. Rounded top + bottom (2 px corners). Use this when the tank graphic must
 * sit flush below text, where disp_tank_graphic's filler-neck would overlap.
 * @param x, y   Top-left corner
 * @param w, h   Dimensions (h >= 8 recommended)
 * @param pct    Fill percentage 0-100
 */
