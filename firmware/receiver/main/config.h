...
// ============================================================================
// PIN DEFINITIONS - ESP32 DevKit v1 (CP2102)
// ============================================================================
// UART2 is used for LoRa (UART1 has restrictions on some ESP32 boards)
...
#define PIN_I2C_SDA             21      // OLED SDA (standard I2C)
#define PIN_I2C_SCL             22      // OLED SCL (standard I2C)
