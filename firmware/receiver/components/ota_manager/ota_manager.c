 ...
 *
 * GitHub check flow:
 *   1. GET api.github.com/repos/Techposts/LoRa-Water-Tank-Monitor/releases/latest
...
#define GITHUB_API_PATH     "/repos/" OTA_GITHUB_OWNER "/" OTA_GITHUB_REPO "/releases/latest"
#define GITHUB_API_URL      "https://" GITHUB_API_HOST GITHUB_API_PATH
...
static void do_github_check(void) {
    ...
    ESP_LOGI(TAG, "Checking GitHub: %s", GITHUB_API_URL);
    ...
    esp_http_client_config_t http_cfg = {
        ...
        .user_data          = &hb,
        .timeout_ms         = 10000,
        .user_agent         = "TankSync/" FIRMWARE_VERSION " (ESP32-C3)",
    };
...
void ota_manager_check_github(void) {
    ...
    ESP_LOGI(TAG, "Manual GitHub check requested");
}
